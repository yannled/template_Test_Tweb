        ...
        return (
            <CreateUser>
                {create => {
                    ...
                    const { name, lastName, email, gender, password1: password } = this.state;
                    ...
                    const onSubmit = (e) => {
                        ...
                        if (!error) {
                            create({ name, lastName, email, gender, password })
                                .then(() => {
                        ...
                        <Paper className={classes.form} elevation={8}>
                            ...
                            <form onSubmit={onSubmit} className={classes.formContent}>
                                ...
                                <FormControl component="fieldset" >
                                    ...
                                    >
                                        <FormControlLabel value="Woman" control={<Radio />} label="Woman" className={classes.radio} />
                                        <FormControlLabel value="Man" control={<Radio />} label="Man" className={classes.radio} />
                                    </RadioGroup>
                                </FormControl>
                                <rb />
                                <TextField
